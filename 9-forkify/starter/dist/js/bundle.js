!(function(t) {
        ...
        (t.exports = function(t, n, e, a) {
          ...
          _
            ? ((v = e(function(t, e, r, i) {
                ...
                if (w(e)) {
                  if (
                    ...
                    return _t in e ? kt(v, e) : At.call(v, e);
                  (o = e), (h = Et(r, n));
                  var y = e.byteLength;
                  if (void 0 === i) {
                  ...
                  c = u / n;
                } else (c = g(e)), (o = new K((u = c * n)));
                for (
                  p(t, '_d', { b: o, o: h, l: u, e: c, v: new J(o) });
                  l < c;
            ...
            : (o(function() {
              ...
              Y(m !== Function.prototype ? F(y).concat(F(m)) : F(y), function(
                t
              ) {
                t in v || p(v, t, y[t]);
              }),
    ...
    ((n = t.exports = function(t, n, e, l, p) {
      ...
      if (o(y)) {
        for (h = c(t.length); h > _; _++)
          if ((g = n ? m(u((v = t[_]))[0], v[1]) : m(t[_])) === s || g === f)
            return g;
      } else
  ...
  function(t, n, e) {
    ...
    var r = '7f5eed143a04705dcab78e0b75f97a53';
  },
  function(t, n, e) {
    var r = e(4),
      i = e(1).document,
    ...
    t.exports = function(t, n, e, v, d, g, y) {
      ...
      if (
        (M &&
          ...
          b.next &&
          (s(b, x, !0), r || 'function' == typeof b[l] || u(b, l, h)),
        S &&
          F &&
          'values' !== F.name &&
          ((E = !0),
  ...
  function(t, n, e) {
    ...
    function L(t, n, e) {
      ...
      for (
        (t = F(t)) != t || t === E
          ...
          : ((r = k(M(t) / A)),
            t * (o = P(2, -r)) < 1 && (r--, (o *= 2)),
            (t += r + s >= 1 ? f / o : f * P(2, 1 - s)) * o >= 2 &&
              (r++, (o /= 2)),
            r + s >= a
              ? ((i = 0), (r = a))
              : r + s >= 1
              ? ((i = (t * o - 1) * P(2, n)), (r += s))
              : ((i = t * P(2, s - 1) * P(2, n)), (r = 0)));
        n >= 8;
        u[l++] = 255 & i, i /= 256, n -= 8
      );
    ...
    function V(t, n, e, r, i, o) {
      var u = h(+e);
      if (u + n > t[j]) throw S(_);
      for (var c = t[I]._b, a = u + t[T], s = r(+i), f = 0; f < n; f++)
        c[a + f] = s[o ? f : n - f - 1];
    }
    if (u.ABV) {
      if (
  ...
  function(t, n, e) {
    t.exports =
      ...
      !e(2)(function() {
        return (
          7 !=
          Object.defineProperty(e(63)('div'), 'a', {
            get: function() {
              return 7;
            }
          }).a
        ...
        a = {
          adapter:
            ...
            '[object process]' === Object.prototype.toString.call(n)
              ? (c = e(130))
              : 'undefined' != typeof XMLHttpRequest && (c = e(130)),
            c),
          transformRequest: [
            function(t, n) {
              return (
    ...
    t.exports = function(t) {
      return new Promise(function(n, s) {
        ...
        if (
          ...
          (p.onabort = function() {
            p && (s(a('Request aborted', t, 'ECONNABORTED', p)), (p = null));
          }),
          (p.onerror = function() {
          ...
          var d = e(334),
            g =
              (t.withCredentials || c(t.url)) && t.xsrfCookieName
                ? d.read(t.xsrfCookieName)
                : void 0;
          g && (l[t.xsrfHeaderName] = g);
        }
        if (
          ('setRequestHeader' in p &&
            r.forEach(l, function(t, n) {
  ...
  function(module, __webpack_exports__, __webpack_require__) {
    ...
    var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(61),
      ...
      _config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(62);
                        ...
                        switch ((t.prev = t.next)) {
                            ...
                            return (
                              ...
                              axios__WEBPACK_IMPORTED_MODULE_0___default()(
                                'https://www.food2fork.com/api/get?key='
                                  .concat(
                                    _config__WEBPACK_IMPORTED_MODULE_1__.a,
                                    '&rId='
                                  )
                                  .concat(this.id)
                              )
                          ...
                          case 3:
                            (n = t.sent),
                              ...
                              (this.img = n.data.recipe.image_url),
          ...
          },
          {
            ...
            value: function parseIngredients() {
              var unitsLong = [
                ...
                units = [].concat(unitsSmall, ['kg', 'g']),
                newIngredients = this.ingredients.map(function(ele) {
                  var ingredient = ele.toLowerCase();
                  unitsLong.forEach(function(t, n) {
                    ingredient = ingredient.replace(t, units[n]);
                  }),
  ...
  function(t, n, e) {
    e(137), (t.exports = e(339));
  },
  function(t, n, e) {
    'use strict';
    e(138);
    var r,
      i = (r = e(310)) && r.__esModule ? r : { default: r };
  ...
  function(t, n, e) {
    ...
    var r = e(1),
      ...
      Z = function(t, n) {
        if (((t = w(t)), (n = x(n, !0)), t !== W || !i(U, n) || i(q, n))) {
          var e = A(t, n);
          return (
    ...
    G ||
      (c(
        (T = function() {
          ...
          return o && z && H(W, t, { configurable: !0, set: n }), K(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
    ...
    for (
      ...
      h(nt[et++]);
    for (var rt = M(h.store), it = 0; rt.length > it; ) d(rt[it++]);
    u(u.S + u.F * !G, 'Symbol', {
      for: function(t) {
  ...
  function(t, n, e) {
    var r = e(0);
    r(r.S, 'Object', { setPrototypeOf: e(68).set });
  },
  function(t, n, e) {
    'use strict';
    var r = e(47),
  ...
  function(t, n, e) {
    ...
    var r = e(0),
      ...
      o = e(76),
      u = ''.startsWith;
    r(r.P + r.F * e(78)('startsWith'), 'String', {
  ...
  function(t, n, e) {
    var r = e(0);
    r(r.P, 'Array', { copyWithin: e(110) }), e(37)('copyWithin');
  },
  function(t, n, e) {
    var r = e(0);
    r(r.P, 'Array', { fill: e(82) }), e(37)('fill');
  },
  function(t, n, e) {
    'use strict';
    var r = e(0),
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var m = []; ; ) {
            ...
            if (null === _) break;
            if ((m.push(_), !g)) break;
            '' === String(_[0]) && (l.lastIndex = c(p, o(l.lastIndex), y));
          }
          for (var b, w = '', x = 0, S = 0; S < m.length; S++) {
            _ = m[S];
            for (
              var E = String(_[0]),
                O = s(f(u(_.index), p.length), 0),
                F = [],
                P = 1;
              P < _.length;
              P++
            )
              F.push(void 0 === (b = _[P]) ? b : String(b));
            var k = _.groups;
            if (h) {
              var M = [E].concat(F, O, p);
              void 0 !== k && M.push(k);
              var A = String(n.apply(void 0, M));
            } else A = d(E, p, O, F, k, n);
        ...
        [
          ...
          function(t, n) {
            ...
            for (var b = 0, w = 0, x = []; w < p.length; ) {
              ...
              if (
                null === E ||
                (S = l(c(m.lastIndex + (h ? 0 : w)), p.length)) === b
              )
                w = u(p, w, g);
              else {
  ...
  function(t, n, e) {
    ...
    var r,
      ...
      _ = (t.exports = e(59)('WeakMap', y, m, s, !0, !0));
    p &&
      h &&
  ...
  function(t, n, e) {
    var r = e(0);
    r(r.G + r.W + r.F * !e(60).ABV, { DataView: e(87).DataView });
  },
  function(t, n, e) {
  ...
  function(t, n, e) {
    e(283), (t.exports = e(7).Array.includes);
  },
  function(t, n, e) {
    'use strict';
    var r = e(0),
  ...
  function(t, n, e) {
    e(285), (t.exports = e(7).Array.flatMap);
  },
  function(t, n, e) {
    'use strict';
    var r = e(0),
  ...
  function(t, n, e) {
    e(288), (t.exports = e(7).String.padStart);
  },
  function(t, n, e) {
    'use strict';
    var r = e(0),
  ...
  function(t, n, e) {
    e(290), (t.exports = e(7).String.padEnd);
  },
  function(t, n, e) {
    'use strict';
    var r = e(0),
  ...
  function(t, n, e) {
    e(292), (t.exports = e(7).String.trimLeft);
  },
  function(t, n, e) {
    'use strict';
    e(40)(
  ...
  function(t, n, e) {
    e(294), (t.exports = e(7).String.trimRight);
  },
  function(t, n, e) {
    'use strict';
    e(40)(
  ...
  function(t, n, e) {
    e(296), (t.exports = e(64).f('asyncIterator'));
  },
  function(t, n, e) {
    e(93)('asyncIterator');
  },
  function(t, n, e) {
    e(298), (t.exports = e(7).Object.getOwnPropertyDescriptors);
  },
  function(t, n, e) {
    var r = e(0),
      i = e(120),
  ...
  function(t, n, e) {
    e(300), (t.exports = e(7).Object.values);
  },
  function(t, n, e) {
    var r = e(0),
      i = e(122)(!1);
  ...
  function(t, n, e) {
    e(302), (t.exports = e(7).Object.entries);
  },
  function(t, n, e) {
    var r = e(0),
      i = e(122)(!0);
  ...
  function(t, n, e) {
    'use strict';
    e(114), e(304), (t.exports = e(7).Promise.finally);
  },
  function(t, n, e) {
    'use strict';
    var r = e(0),
  ...
  function(t, n, e) {
    e(306), e(307), e(308), (t.exports = e(7));
  },
  function(t, n, e) {
    var r = e(1),
      i = e(0),
          ...
          (o._invoke = (function(t, n, e) {
            ...
            return function(i, o) {
              ...
              for (e.method = i, e.arg = o; ; ) {
                ...
                var a = s(t, n, e);
                if ('normal' === a.type) {
                  if (((r = e.done ? h : l), a.arg === v)) continue;
                  return { value: a.arg, done: e.done };
                }
                'throw' === a.type &&
                  ((r = h), (e.method = 'throw'), (e.arg = a.arg));
              }
            };
          })(t, e, u)),
          o
        ...
        (P.prototype = {
          ...
          finish: function(t) {
            for (var n = this.tryEntries.length - 1; n >= 0; --n) {
              ...
              if (e.finallyLoc === t)
                return this.complete(e.completion, e.afterLoc), F(e), v;
            }
          },
          catch: function(t) {
            for (var n = this.tryEntries.length - 1; n >= 0; --n) {
  ...
  function(t, n, e) {
    t.exports =
      ...
      !e(124)(function() {
        return (
          7 !=
          Object.defineProperty(e(319)('div'), 'a', {
            get: function() {
              return 7;
            }
          }).a
  ...
  function(t, n, e) {
    ...
    var h = (function() {
          ...
          (e = [
            {
              ...
              value: function(t, n, e) {
                var r = { id: l()(), count: t, unit: n, ingredient: e };
      ...
      y = function() {
        var t = document.querySelector('.'.concat(d));
        t && t.parentElement.removeChild(t);
      },
      m = function() {
        (v.searchResList.innerHTML = ''), (v.searchResPages.innerHTML = '');
      },
      _ = function(t) {
      ...
      w = function(t) {
        ...
        v.searchResList.insertAdjacentHTML('beforeend', n);
      },
      x = function(t, n) {
        ...
        1 === t && i > 1
          ...
          : t < i &&
            (r = '\n    '
              .concat(x(t, 'prev'), '\n    ')
              .concat(x(t, 'next'), '\n    ')),
          v.searchResPages.insertAdjacentHTML('afterbegin', r);
      },
      E = function(t) {
        var n =
          ...
          r = (n - 1) * e,
          i = n * e;
        t.slice(r, i).forEach(w), S(n, t.length, e);
      },
      O = e(91);
    function F(t, n) {
      return (
    ...
    var P = function(t) {
        if (t) {
          ...
          if (!e[1]) return n;
          if (0 === r) {
            var i = new O.Fraction(n);
            return ''.concat(i.numerator, '/').concat(i.denominator);
          }
          var o = new O.Fraction(n - r);
          return ''
            .concat(r, ' ')
            .concat(o.numerator, '/')
      ...
      k = function(t, n) {
        ...
        v.recipe.insertAdjacentHTML('afterbegin', e);
      },
      M = function(t) {
        (document.querySelector('.recipe__info-data--people').textContent =
          ...
          Array.from(document.querySelectorAll('.recipe__count')).forEach(
            function(n, e) {
              n.textContent = P(t.ingredients[e].count);
            }
          );
      },
      A = function(t) {
      ...
      I = function(t) {
        v.likesMenu.style.visibility = t > 0 ? 'visible' : 'hidden';
      },
      j = function(t) {
        var n = '\n  <li>\n  <a class="likes__link" href="#'
          ...
          .concat(t.author, '</p>\n      </div>\n  </a>\n</li>\n  ');
        v.likesList.insertAdjacentHTML('beforeend', n);
      };
    function T(t, n) {
      for (var e = 0; e < n.length; e++) {
        var r = n[e];
    ...
    v.searchForm.addEventListener('submit', function(t) {
      t.preventDefault(), D();
    }),
      v.searchRes.addEventListener('click', function(t) {
        var n = t.target.closest('.btn-inline');
        if (n) {
          var e = parseInt(n.dataset.goto, 10);
          m(), E(C.search.result, e);
        }
      });
    var B = (function() {
      var t = N(
    ...
    ['load', 'hashchange'].forEach(function(t) {
      ...
      C.list || (C.list = new h()),
        C.recipe.ingredients.forEach(function(t) {
          !(function(t) {
            ...
            v.shopping.insertAdjacentHTML('beforeend', n);
          })(C.list.addItem(t.count, t.unit, t.ingredient));
        });
    };
    v.shopping.addEventListener('click', function(t) {
    ...
    var q = function() {
      ...
      I(C.likes.getNumLikes());
    };
    v.recipe.addEventListener('click', function(t) {
      t.target.matches('.btn-decrease,.btn-decrease *')
        ? C.recipe.servings > 1 && (C.recipe.updateServings('dec'), M(C.recipe))
        : t.target.matches('.btn-increase,.btn-increase *')
        ? (C.recipe.updateServings('inc'), M(C.recipe))
        : t.target.matches('.recipe__btn--add,.recipe__btn--add *')
        ? U()
        : t.target.matches('.recipe__love,.recipe__love *') && q();
    }),
